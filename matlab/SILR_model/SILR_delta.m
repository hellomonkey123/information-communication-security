...
for j = 1:length(delta)
    for i = 1:N1
        ...
        + (1 - alpha)*P_R*(1 - x_S(j,i))*k*x_S(j,i) + (1 - delta(j))*P_R*x_I(j,i)*k*x_S(j,i))*t;
        x_I(j,i+1) = x_I(j,i)+(-delta(j)*x_I(j,i)- (1 - delta(j))*P_R*x_I(j,i)*x_S(j,i)*k + (1 -tau)*P_I*x_R(j,i)*x_S(j,i)*k ......
